...
function changePlayers() {
  ...
  document.querySelector("#turnRound").textContent = `PLAYER ${currentPlayer}`;
}
...
next.addEventListener("click", () => {
  ...
  /*  const url = "https://juliamj222.github.io/la-quesera/round2Eng.html?"; */
  const url = "https://juliamj222.github.io/la-quesera/round2Eng.html?";
...
window.addEventListener("load", () => {
  document.querySelector("#turnRound").textContent = `PLAYER ${currentPlayer}`; // turns
